...
Widget _buildTopPlayersSection() {
  ...
  final topPlayers = _game.players.length >= 2 
    ...
    child: Column(
      children: [
        Row(
          ...
          children: [
            ...topPlayers.map((player) => Expanded(
              child: PlayerHandDisplay(player: player),
            )),
                ...
                return Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      shadows: [Shadow(offset: Offset(2.0, 2.0), blurRadius: 0, color: Color.fromRGBO(63, 63, 63, 1))],
                    ),
                  ),
                );
              } else {
  ...
  return Column(
      children: [
        ...
        Row(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...bottomPlayers.map((player) => Expanded(
              child: PlayerHandDisplay(player: player),
            )),
          ],
        ),
